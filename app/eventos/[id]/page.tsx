...
export default function page({ params }: IPageParam) {
   ...
   return (
      <section className='pt-[100px] px-20 space-y-5'>
               ...
               <div>
                  <div className='space-y-6'>
                     <div className='flex items-center gap-4'>
                        <button type='button' className='rounded-full size-10 flex items-center justify-center bg-violet-500' aria-label='shared button'>
                           <Icons.bookmark className='text-white' width={30} />
                        </button>
                        <button type='button' className='rounded-full size-10 flex items-center justify-center bg-violet-500' aria-label='shared button'>
                           <Icons.link className='text-white' width={30} />
                        </button>
                        <Button type='button' className='bg-violet-500 rounded-md hover:bg-violet-700 flex gap-2' aria-label='buy ticket'>
                           Ver bilhete
                        </Button>
                     </div>
